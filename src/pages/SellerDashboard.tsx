					...
					<TabsContent value='dashboard' className='space-y-6'>
						...
						<Card className='shadow-card'>
							<CardHeader>
								...
								<CardDescription>
									Yangi kelgan buyurtmalar ro'yxati
								</CardDescription>
							</CardHeader>
							<CardContent>
										...
										>
											<div className='flex-1'>
												...
												<p className='text-sm text-muted-foreground'>
													{order.buyer} • {order.quantity} dona
												</p>
											</div>
									...
									<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
										...
										<div className='space-y-2'>
											...
											<Select>
												...
												<SelectContent>
													<SelectItem value='fruit-trees'>
														Mevali daraxtlar
													</SelectItem>
													<SelectItem value='deciduous-trees'>
														Bargli daraxtlar
													</SelectItem>
													<SelectItem value='evergreen-trees'>
								...
								<Card key={product.id} className='shadow-card'>
									<CardContent className='p-4'>
										...
										<div className='space-y-2'>
											...
											<p className='text-sm text-muted-foreground'>
												Omborda: {product.stock} dona • {product.orders}{' '}
												buyurtma
											</p>
										</div>
						...
						<Card className='shadow-card'>
							...
							<CardContent className='space-y-4'>
								...
								<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
									<div className='space-y-2'>
										...
										<Input
											id='profile-email'
											type='email'
											defaultValue='oybek@example.com'
										/>
									</div>
									<div className='space-y-2'>
								...
								<div className='space-y-2'>
									...
									<Input
										id='profile-business'
										defaultValue="Tursunov Ko'chatlar Pitomniki"
									/>
								</div>
								...
								<div className='space-y-2'>
									...
									<Textarea
										id='profile-address'
										defaultValue="Toshkent viloyati, Chirchiq shahar, Navbahor ko'chasi 15-uy"
									/>
								</div>
