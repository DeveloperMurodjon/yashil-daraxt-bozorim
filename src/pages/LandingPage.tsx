	...
	const features = [
		{
			...
			description:
				'Barcha sotuvchilar admin tomonidan tasdiqlangan va tekshirilgan',
		},
		{
			icon: Shield,
			title: 'Xavfsiz Savdo',
			description:
				"To'g'ridan-to'g'ri sotuvchi bilan bog'lanish va xavfsiz to'lov",
		},
		{
			icon: Award,
	...
	const testimonials = [
		{
			...
			role: "Bog'bon",
			content:
				"Bu platforma orqali eng sifatli ko'chatlarni topib oldim. Sotuvchilar juda professional va ishonchli.",
			rating: 5,
		},
		{
			...
			role: 'Fermer',
			content:
				"Ko'chatlar bozori men uchun eng yaxshi tanlov bo'ldi. Oson, qulay va ishonchli.",
			rating: 5,
		},
		{
			name: 'Oybek Tursunov',
			role: 'Sotuvchi',
			content:
				"O'z mahsulotlarimni osongina sotishga imkon berdi. Admin tizimi juda yaxshi ishlaydi.",
			rating: 5,
		},
	]
						...
						<div className='grid grid-cols-2 md:grid-cols-4 gap-6 mt-16'>
							{stats.map((stat, index) => (
								<div key={index} className='text-center'>
									<div className='text-2xl md:text-3xl font-bold text-forest'>
										{stat.number}
									</div>
				...
				<div className='container mx-auto px-4'>
					<div className='text-center mb-16'>
						...
						<p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
							Ko'chatlar bozori - bu ishonchli, xavfsiz va qulay ko'chatlar
							savdo platformasi
						</p>
					</div>
			...
			<section className='py-20 bg-gradient-to-r from-forest to-moss text-primary-foreground'>
				<div className='container mx-auto px-4 text-center'>
					...
					<p className='text-xl mb-8 opacity-90 max-w-2xl mx-auto'>
						Ko'chatlar bozorida o'z o'rningizni toping. Xaridor bo'ling yoki
