...
function Sidebar({ active, onNavigate, onLogout }: Props) {
	return (
		<div className='h-screen bg-muted p-4 sm:p-6 w-64 flex-shrink-0 flex flex-col gap-6 font-sans shadow-lg'>
			...
			<div className='space-y-3 flex-grow'>
				...
				<button
					onClick={onLogout}
					className='w-full flex items-center p-3 rounded-lg transition-all duration-300 bg-white hover:bg-red-100 text-gray-700 hover:text-red-500 mt-auto'
				>
